...
var image_name='category_image'+current_hour+'.jpg';

// fs.writeFile("client/uploads/admin_uploads/"+current_hour+".jpg", new Buffer(req.body.files, "base64"), function(err) {
